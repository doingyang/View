...
public class AlphaTabsIndicator extends LinearLayout {
    ...
    private OnTabChangedListner mListener;
    ...
    /*需要检查登录状态的Tab*/
    private String checkLoginTabName = "xxx";
    ...
    public void setOnTabChangedListener(OnTabChangedListner listener) {
    ...
    public void setTabCurrentItem(int tabIndex) {
    ...
    public void setCheckLoginTabName(String tabName) {
        this.checkLoginTabName = tabName;
    }
    ...
    public void setTabClickable(boolean canClick) {
        for (AlphaTabView tabView : mTabViews) {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            //需要校验登录状态的Tab界面：权益
            String tabName = getTabView(currentIndex).getText();
            if (checkLoginTabName.equalsIgnoreCase(tabName)) {
                // TODO: 2021/2/24 0024
                return;
            }
