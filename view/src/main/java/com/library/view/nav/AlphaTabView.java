...
public class AlphaTabView extends View {
    ...
    private @ColorInt
    int mTextColorNormal = 0xFF999999;    //描述文本的默认显示颜色
    private @ColorInt
    int mTextColorSelected = Color.parseColor("#4E8CEE");  //述文本的默认选中显示颜色
    ...
    public AlphaTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPadding = (int) a.getDimension(R.styleable.AlphaTabView_paddingTextWithIcon, mPadding);
        a.recycle();
        initText();
    }
     ...
     * 设置选中字体颜色
     */
    public void setTextColorSelected(@ColorInt int colorSelected) {
        this.mTextColorSelected = colorSelected;
        if (mTextPaint != null) {
            mTextPaint.setColor(mTextColorSelected);
        }
        invalidateView();
    ...
    public void setTextColorNormal(@ColorInt int colorNormal) {
        this.mTextColorNormal = colorNormal;
        if (mTextPaint != null) {
            mTextPaint.setColor(mTextColorNormal);
        }
        invalidateView();
